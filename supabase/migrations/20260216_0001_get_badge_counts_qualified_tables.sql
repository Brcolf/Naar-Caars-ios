-- Fix 42P01: qualify table names and set search_path so get_badge_counts works with SECURITY DEFINER.
-- Replaces function body to use public.messages, public.conversation_participants, public.notifications.
