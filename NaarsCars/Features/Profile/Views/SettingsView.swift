        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    // Privacy Policy Link
                    Link(destination: URL(string: Constants.URLs.privacyPolicy) ?? URL(string: "about:blank")!) {
                        Label {
                            HStack {
                    ...
                    Link(destination: URL(string: Constants.URLs.termsOfService) ?? URL(string: "about:blank")!) {
                        Label {
                            HStack {
